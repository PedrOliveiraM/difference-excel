...
botao_comparar = tk.Button(frame, text="Comparar",borderwidth=2,relief="solid" ,command=comparar_planilhas , width=20, height=2 , font=("Arial",12,"bold"))
botao_comparar.grid(row=7, column=0, columnspan=2, padx=10, pady=25)  # Adicionando padx e pady
botao_comparar.config(bg="green", fg="white" , )
root.mainloop()
